...
Based on previous experience, the prior version of pressor (developped [here](https://github.com/tyravex/pressor)) was able to compress a photo gallery by a factor of ~8 (40gb to 5gb), with minimal loss in quality, thanks to new clever and efficient codecs (AV1, AVIF and JXL to name a few) and superior encoding complexity.

For now, this full rewrite is just at its beginning, so please by patient before I release the first version.
...
- Search by extentions, file content (mime type), or both
...
- Toggle renaming for any media type or extentions
- Choose renaming strategy (regex, timestamps)
- Toggle loglevels or logging
